...
public:
	bool initial(HyperParams& opts){
		...
		SHI__p1_C__n0_C.initial();
		SHI__p1_Wfc__n0_C.initial();
		SHI__p2_Ct__p1_Ct__p2_Ct.initial();
		PW__p1_C__n0_C.initial();
		PW__p1_Wfc__n0_C.initial();
		PW__p2_Ct__p1_Ct__p2_Ct.initial();
		PW__p1_W.initial();
		PW__p1_Wd__p1_Wl.initial();
		PW__p1_WSingle.initial();
		PW__p1_W__n0_C.initial();
		PW__p2_W__p1_W.initial();
		PW__p2_Wfc__p1_W.initial();
		PW__p2_Wec__p1_W.initial();
		PW__p2_Wfc__p1_Wfc.initial();
		PW__p2_Wec__p1_C.initial();
		PW__p2_W__p1_Wl.initial();
		PW__p2_Wl__p1_W.initial();
		PW__p2_W__p1_C.initial();
		PW__p1_Wfc__p1_Wl.initial();
		PW__p1_C__p1_Wl.initial();
		PW__p1_Wmc__p1_C__p1_T.initial();
		...
		SHO__p1_W__p1_T.initial();
		SHO__p1_W__p2_T.initial();
		SHO__p2_Wec__p1_W__p1_T.initial();
		SHO__p2_Wec__p1_W__n0_C__p1_T.initial();
		SHO__p1_C__p1_T.initial();
		SHO__p1_Cc__p1_T.initial();
		SHO__p1_T__ac.initial(opts.action_num);
		SHO__p1_Wl__p1_T__ac.initial(opts.action_num);
		SHO__p1_Wl__p1_T__p2_T.initial();
		...
		SHI__p1_C__n0_C__p1_T.initial();
		SHI__p1_Wfc__n0_C__p1_T.initial();
		SHI__p2_Ct__p1_Ct__n0_Ct__p1_T.initial();
		PW__p1_Whc__n0_C.initial();
		PW__p2_Whc__p1_Whc.initial();
		PW__p2_Wfc__p1_Whc.initial();
		PW__p2_Wec__p1_Whc.initial();
		PW__p2_W__p1_Whc.initial();
		PW__p2_Whc__p1_W.initial();
		PW__p2_Whc__p1_Wl.initial();
		PW__p2_Wl__p1_Whc.initial();
		PW__p2_Whc__p1_C.initial();
		PW__p1_Whc__p1_Wl.initial();
		SHO__p1_Whc__p1_T.initial();
		SHO__p1_Whc__p2_T.initial();
		SHO__p2_Wec__p1_Whc__p1_T.initial();
		SHO__p2_Wec__p1_Whc__n0_C__p1_T.initial();
		SHO__p1_Whc__ac.initial(opts.action_num);
		SHO__p1_Whc__n0_C__p1_T.initial();
		...
		PW__p1_Wd__p1_T__p1_Wl.initial();
